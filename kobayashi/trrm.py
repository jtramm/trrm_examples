...
def create_random_ray_model():
    ...
    y_low  = openmc.XPlane(y0=0.0,boundary_type='reflective') 
    y_high = openmc.XPlane(y0=y,boundary_type='vacuum') 
    
    z_low  = openmc.XPlane(z0=0.0,boundary_type='reflective') 
    z_high = openmc.XPlane(z0=z,boundary_type='vacuum') 
